...
function addTradingViewWidget(container, ticker, impact) {
    ...
    script.textContent = JSON.stringify({
        ...
        dateRange: '1D',
        colorTheme: 'dark',
        trendLineColor: impact.direction === 'UP' ? 'rgba(34, 197, 94, 1)' : 'rgba(239, 68, 68, 1)',
        underLineColor: impact.direction === 'UP' ? 'rgba(34, 197, 94, 0.3)' : 'rgba(239, 68, 68, 0.3)',
...
export async function renderCharts(impacts) {
